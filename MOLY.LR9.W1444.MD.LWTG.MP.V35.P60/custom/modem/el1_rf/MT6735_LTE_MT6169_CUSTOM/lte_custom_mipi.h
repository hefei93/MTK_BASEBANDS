...
/*MIPI ASM     */
/*FDD TX ON    */
#define  LTE_FDD_MIPI_ASM_TX_ON0   US2OFFCNT(3)
...
/*MIPI PA     */
/*FDD TX ON    */
#define  LTE_FDD_MIPI_PA_TX_ON0    US2OFFCNT(5)
...
*/
#define  LTE_MIPI_BYPASS_BAND_INDICATOR1_POWER_COMP      0
#define  LTE_MIPI_BYPASS_BAND_INDICATOR2_POWER_COMP      0
#define  LTE_MIPI_BYPASS_BAND_INDICATOR3_POWER_COMP      0
...
If bypass < filter by 1.5dB, the value is -384 (=-1.5*256)
*/
#define  LTE_MIPI_BYPASS_BAND_INDICATOR1_COUPLER_COMP    0
#define  LTE_MIPI_BYPASS_BAND_INDICATOR2_COUPLER_COMP    0
#define  LTE_MIPI_BYPASS_BAND_INDICATOR3_COUPLER_COMP    0
