...
kal_int16 const TD_GSM_COCRYSTAL[]={
 ...
 // [7:4]     [3:0] 	
  ...
  /////////////////////DBB_BPI_AREA1 begin (fix for TX Control )/////////////////////////////
		// V1	       V2	        V3		        	 RFconflict 								
#ifdef __TAS_SUPPORT__
     (1<<ANT0_BPI_NUM) + (0<<0) + (1<<28),          //TX_CTRL_BITMASK   data[1]	  
...
#else									
     (0<<0) + (1<<28),          //TX_CTRL_BITMASK   data[1]	
	...
	/////////////////////DBB_BPI_AREA2 begin (fix for RX Control)///////////////////////////
		// V1	       V2	        V3		    		  RFconflict										
#ifdef __TAS_SUPPORT__
     (1<<ANT0_BPI_NUM) + (0<<0) + (1<<28),           //RX_CTRL_BITMASK   data[12]
...
#else										
     (0<<0) + (1<<28),           //RX_CTRL_BITMASK   data[12]	
  ...
  /////////////////////DBB_BPI_AREA1 begin (fix for TX Control )/////////////////////////////
     ...
     (1<<ANT1_BPI_NUM) + (0<<0) + (1<<28),          //TX_CTRL_BITMASK   data[1]	  
	...
	/////////////////////DBB_BPI_AREA2 begin (fix for RX Control)///////////////////////////
		//MODE	  BS1	   BS2		  VC1	  VC2		  RFconflict										
     (1<<ANT1_BPI_NUM) + (0<<0) + (1<<28),           //RX_CTRL_BITMASK   data[12]	
