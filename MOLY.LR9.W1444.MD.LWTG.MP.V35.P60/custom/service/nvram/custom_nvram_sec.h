...
#ifdef __HQ_NW_LOCK_ENLARGE_COUNT__
...
{
    SML_ALL_LOCK,
    SML_SIM1_SIM2_UNLOCK,//sim1 unlock sim2
    SML_SIM1_SIM2_VERIFY,//sim1 verify sim2
    SML_SIM1_SIM2_VERIFY_UNLOCK,//sim1 verify sim2 and sim1 unlock sim2
    SML_NO_SIM1_SIM2_VERIFY,// no sim1 , sim2 verify
    SML_SIM1_SIM2_NO_LINK,// sim1/sim2 no link
    SML_SIM1_SIM2_HONGKONG,
    SML_TOTAL
}sml_type_enum;
#endif
