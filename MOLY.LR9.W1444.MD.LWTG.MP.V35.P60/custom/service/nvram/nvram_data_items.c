...
/* 23rd byte */
  ...
  //0x20 |  //SBP_CUSTOM_FPLMN_USED
    ...
    0x10 |
#endif
#ifdef __BAR_EUTRA_FREQ_BASED_ON_EUTRA_DISABLE_TIMER__
    0x20 | /* SBP_BAR_EUTRA_FREQ_BASED_ON_EUTRA_DISABLE_TIMER */
#endif
#if defined(__SDM_DISABLE_SMS_OVER_WIFI__)
    0x40 |
#endif
#if defined(__MPT_REJ_8_MAPPING_TO_15__)
    0x80 |
#endif
    0x00,

    /* 27th byte */
/* #if defined(__X2G_HO_START_CPHR_CR0585_ENABLE__) */
    0x00 | /* SBP_X2G_HO_START_CPHR_CR0585_ENABLE default on */
/* #endif */
    0x00
    }
}
