...
//        NVRAM_EF_ADC_LID = 66,
	...
	NVRAM_EF_SML_ANTI_BREAK_LID,
#endif
#ifdef __HQ_SML_LOCK_NV_EXT__
	NVRAM_EF_SML_LID_EXT,
#endif
...
#endif
#ifdef __HQ_SML_LOCK_NV_ANTI_BREAK__
#define NVRAM_EF_SML_ANTI_BREAK_SIZE   sizeof(nvram_sml_context_struct)
#define NVRAM_EF_SML_ANTI_BREAK_TOTAL  10
#endif

#ifdef __HQ_SML_LOCK_NV_EXT__
#define SML_TYPE_SUPPORT    20 /* SML type*/
#define SML_POP_SUPPORT           2   /* SML_POP */
#define SML_CANCEL_POP_SUPPORT           1   /* SML_POP */
#define SML_SIZE_OF_UNLOCK_TIME         4
#define SML_UNLOCK_POP_SUPPORT           1   /* SML_POP UNLOCK*/
#define SML_CODE_OTHER           10   /* SML_CODE_OTHER */
typedef struct {
    kal_uint8	sml_type[SML_TYPE_SUPPORT];		/* 20 */
    kal_uint8	need_pop[SML_POP_SUPPORT];		/* 2 */
    kal_uint8	can_cancel_pop[SML_CANCEL_POP_SUPPORT];		/* 1 */
    kal_uint8   unlock_time[SML_SIZE_OF_UNLOCK_TIME];		/* 4 */
    kal_uint8   unlock_pop[SML_UNLOCK_POP_SUPPORT];		/* 1 */
    kal_uint8	code_other[SML_CODE_OTHER];		/* 10 */
} nvram_sml_context_struct_ext;

#define NVRAM_EF_SML_LID_EXT_SIZE sizeof(nvram_sml_context_struct_ext)               
#define NVRAM_EF_SML_LID_EXT_TOTAL 1
