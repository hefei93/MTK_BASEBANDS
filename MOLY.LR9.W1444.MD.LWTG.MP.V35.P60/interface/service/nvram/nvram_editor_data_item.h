...
#define NVRAM_EF_SML_ANTI_BREAK_LID_VERNO                              "002"
#endif
#ifdef __HQ_SML_LOCK_NV_EXT__
#define NVRAM_EF_SML_LID_EXT_VERNO                              "002"
#endif
...
#define NVRAM_EF_SBP_MODEM_CONFIG_LID_VERNO "042"
...
#ifdef __HQ_SML_LOCK_NV_ANTI_BREAK__
        LID_BIT VER_LID(NVRAM_EF_SML_ANTI_BREAK_LID)
            nvram_sml_context_struct *NVRAM_EF_SML_TOTAL
            {
            };
#endif
#ifdef __HQ_SML_LOCK_NV_EXT__
        LID_BIT VER_LID(NVRAM_EF_SML_LID_EXT)
            nvram_sml_context_struct_ext *NVRAM_EF_SML_LID_EXT_TOTAL
            {
            };
#endif
END_NVRAM_DATA
