...
#define PHS_Mac_Drx_State_String(v1)  (unsigned char)(v1+182)
...
#define PHS_LOG_SRVCC_SHORT_GAP_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6601, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
	...
	#define PHS_LOG_CLASSIFY() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6701, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_CLASSIFY()
#endif
#define PHS_LOG_CLASSIFY_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6701, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
