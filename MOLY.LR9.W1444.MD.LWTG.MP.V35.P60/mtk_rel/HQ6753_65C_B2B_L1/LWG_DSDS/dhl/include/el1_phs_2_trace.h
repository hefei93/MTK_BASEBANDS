...
#define PHS_LOG_RX_LAST_TRACK_TIME_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2602, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
	...
	#define PHS_LOG_AUTO_GAP_ST(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2702, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_AUTO_GAP_ST(v1)
#endif
#define PHS_LOG_AUTO_GAP_ST_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2702, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_AUTO_GAP_LEN_FROM_AP(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2802, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define PHS_LOG_AUTO_GAP_LEN_FROM_AP(v1)
#endif
#define PHS_LOG_AUTO_GAP_LEN_FROM_AP_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2802, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PHY_DVFS(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2902, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_PHY_DVFS(v1, v2)
#endif
#define PHS_LOG_PHY_DVFS_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2902, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NON_SLEEP_CAUSE(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2A02, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_NON_SLEEP_CAUSE(v1)
#endif
#define PHS_LOG_NON_SLEEP_CAUSE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2A02, (unsigned char)(v1), TRC_BOXSTER_PAD))
