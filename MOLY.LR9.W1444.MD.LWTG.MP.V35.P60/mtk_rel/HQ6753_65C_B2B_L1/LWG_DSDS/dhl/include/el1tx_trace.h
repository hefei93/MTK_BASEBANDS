...
#define Tx_CH_Str(v1)  (unsigned char)(v1+167)
#define Tx_CSI_Str(v1)  (unsigned char)(v1+171)
#define Tx_ACQI2_Hi_Str(v1)  (unsigned char)(v1+179)
#define Rx_Qual_Str(v1)  (unsigned char)(v1+184)
#define Rx_DCI_Str(v1)  (unsigned char)(v1+196)
#define UMPR_Src0_Str(v1)  (unsigned char)(v1+208)
#define UMPR_Src1_Str(v1)  (unsigned char)(v1+215)
#define TAS_Str(v1)  (unsigned char)(v1+218)
