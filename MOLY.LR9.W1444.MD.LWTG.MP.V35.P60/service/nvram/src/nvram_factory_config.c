...
const nvram_sml_context_struct NVRAM_EF_SML_ANTI_BREAK_DEFAULT = 
{	SML_MAGIC_HEAD_VALUE, 
	{{SML_STATE_UNLOCK,0xFF,0,0},	   /* Category N */
	{SML_STATE_UNLOCK,0xFF ,0,0},   /* Category NS */
	{SML_STATE_UNLOCK,0xFF ,0,0},   /* Category SP */
	{SML_STATE_UNLOCK,0xFF ,0,0},	  /* Category C */
	{SML_STATE_UNLOCK,0xFF ,0,0},  /* Category SIM */
	{SML_STATE_UNLOCK,0xFF ,0,0},   /* Link NS-SP */
	{SML_STATE_UNLOCK,0xFF ,0,0}},    /* Link SIM-C */
...
// RF Calibration history NVRAM items
...
#ifdef __HQ_SML_LOCK_NV_ANTI_BREAK__
	{
        ...
        NVRAM_EF_SML_ANTI_BREAK_TOTAL,
        NVRAM_EF_SML_ANTI_BREAK_SIZE,
        NVRAM_NORMAL(&NVRAM_EF_SML_ANTI_BREAK_DEFAULT), 
        NVRAM_CATEGORY_USER| NVRAM_CATEGORY_IMPORTANT_L4,
        NVRAM_ATTR_MSP | NVRAM_ATTR_CONFIDENTIAL,
        "MP7D",
        VER(NVRAM_EF_SML_ANTI_BREAK_LID)
    },
#endif
#ifdef __HQ_SML_LOCK_NV_EXT__
    {
        NVRAM_EF_SML_LID_EXT,
        NVRAM_EF_SML_LID_EXT_TOTAL,
        NVRAM_EF_SML_LID_EXT_SIZE,
        NVRAM_NORMAL(&NVRAM_EF_ZERO_DEFAULT),
        NVRAM_CATEGORY_USER| NVRAM_CATEGORY_IMPORTANT_L4,
        NVRAM_ATTR_MSP | NVRAM_ATTR_CONFIDENTIAL,
        "MP8D", 
        VER(NVRAM_EF_SML_LID_EXT)
    },
#endif
};
